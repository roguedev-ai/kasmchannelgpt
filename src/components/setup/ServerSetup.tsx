        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-medium text-green-900 mb-1">Enhanced Security</h3>
            ...
            <div>
              ...
              <ol className="space-y-4 text-sm text-gray-600">
                <li className="flex items-start gap-3">
                  <span className="flex-shrink-0 w-6 h-6 bg-brand-100 text-brand-700 rounded-full flex items-center justify-center text-xs font-semibold">
                    1
                  </span>
                  <div>
                    ...
                    <p>Copy <code className="bg-gray-100 px-1 py-0.5 rounded">.env.example</code> to <code className="bg-gray-100 px-1 py-0.5 rounded">.env.local</code></p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <span className="flex-shrink-0 w-6 h-6 bg-brand-100 text-brand-700 rounded-full flex items-center justify-center text-xs font-semibold">
                  ...
                  <div>
                    ...
                    <p>Set <code className="bg-gray-100 px-1 py-0.5 rounded">CUSTOMGPT_API_KEY=your_api_key_here</code></p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <span className="flex-shrink-0 w-6 h-6 bg-brand-100 text-brand-700 rounded-full flex items-center justify-center text-xs font-semibold">
                  ...
                  <div>
                    ...
                    <p>Run <code className="bg-gray-100 px-1 py-0.5 rounded">npm run dev</code> to apply changes</p>
                  </div>
                </li>
              </ol>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-amber-800 text-sm">
                  Never commit your <code className="bg-amber-100 px-1 py-0.5 rounded">.env.local</code> file to version control.
                  It should be listed in your <code className="bg-amber-100 px-1 py-0.5 rounded">.gitignore</code> file.
                </p>
              </div>
            </div>
          </div>
